...
# LESS and CSS
LESS 		 	= style.less modules.less base.less light.less color.less dark.less colorful.less typography.less design1.less design2.less design3.less design-p1.less design-p2.less  #style1.less #style2.less
...
# target: upgrade-responsive-menu	- Upgrade LESS module - Responsive meu
